...
class BMISummary {
  LinkedList<String> under; // list of strings that contain the names of people who are underweight
  LinkedList<String> healthy; // list of strings that contain the names of people who are healthy
  LinkedList<String> over; // list of strings that contain the names of people who are overweight
  LinkedList<String> obese; // list of strings that contain the names of people who are obese
