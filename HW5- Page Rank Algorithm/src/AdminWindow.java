...
class AdminWindow {
	...
	public void adminScreen() throws LowerRateException, InvalidRateException {
		System.out.println("-------------------------------------");
		...
		if (choice.equals("done"))
			...
			} catch (LowerRateException lre) {
				System.out.println("Inputed rate is lower than original");
				adminScreen();
			} catch (InvalidRateException ire) {
				System.out.println("Inputed rate is not ");
				adminScreen();
			}
			adminScreen();
		}
